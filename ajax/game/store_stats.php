...
$query = 	'INSERT INTO _game_stats' .
			' (ip, blocks, maps, level, scores, record, achieved, play_time, saved) VALUES' .
			' (:ip, :blocks, :maps, :level, :scores, :record, :achieved, :play_time, NOW())';

$statement = $db_connection->prepare($query);

$statement->bindValue(':ip', $ip, PDO::PARAM_STR); 
$statement->bindValue(':blocks', $blocks, PDO::PARAM_INT); 
$statement->bindValue(':maps', $maps, PDO::PARAM_INT); 
